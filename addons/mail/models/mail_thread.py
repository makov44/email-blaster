    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
        ...
        try:
            ...
            subject_filter = ['Automatic reply', 'automated response', 'auto responder', 'Automated Message', 'Auto-Reply',
                              ...
                              'Automated Reply', 'Automatische Antwort', 'Auto-generated email response',
            ...
            body = body[:300]
            body_filter = ['I am out of the office', 'I\'ll be out of the office', 'I will be out of the office', 'I will out of the office', 'I am currently out of the office', 'our office will be closed',
                           'Our office is closed', 'This email address is no longer valid', 'email address has changed', 'This email address is only for', 'We have closed for the weekend',
                           ...
                           'I will no longer be checking this email', 'Your Ticket has been received', 'Ticket Created', 'created a ticket', 'Thank you for submitting your request', 'this email address is not monitored',
                           'Your message has been received', 'Your email has been received', 'Your message was recieved', 'Your message has been received',
                           'We have received your email', 'We have received your inquiry', 'This inbox is no longer monitored', 'Our goal is to respond within',
                           ...
                           'If this is an insurance emergency', 'If your email is concerning an urgent matter', 'One of our representatives may contact you', 'I have received your email',
                           'We are now processing your request', 'We have received your email', 'Email messages will be filtered', 'Please do not utilize this email', 'spam closing',
